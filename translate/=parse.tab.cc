...
{
       0,     0,     3,     8,     9,    16,    17,    20,    23,    24,
      33,    41,    50,    58,    59,    62,    63,    69,    70,    77,
      78,    84,    91,    92,    95,    96
};
...
{
      16,     0,    -1,    17,    19,    21,    23,    -1,    -1,    17,
       4,    14,    10,    18,    11,    -1,    -1,    18,    14,    -1,
      18,    13,    -1,    -1,    19,     7,     5,    13,    14,    10,
      20,    11,    -1,    19,     5,    13,    14,    10,    20,    11,
      -1,    19,     7,     6,    13,    14,    10,    20,    11,    -1,
      19,     6,    13,    14,    10,    20,    11,    -1,    -1,    20,
      14,    -1,    -1,     8,    10,    22,    25,    11,    -1,    -1,
       9,    10,    24,    25,    11,    27,    -1,    -1,    25,    14,
      12,    13,    26,    -1,    25,    14,    12,    13,    10,    26,
      -1,    -1,    26,    13,    -1,    -1,    27,    11,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   202,   202,   205,   206,   209,   210,   211,   214,   215,
     222,   225,   232,   237,   238,   243,   243,   246,   246,   249,
     250,   264,   280,   281,   286,   287
};
#endif
...
{
  "$end", "error", "$undefined", "ZERO", "TYPE", "PRED", "FUNC", "SHOW",
  "ISTRUE", "ARBITRARY", "COLON", "NEWLINE", "SLASH", "NUMBER",
  "IDENTIFIER", "$accept", "transl", "types", "dom_els", "symbols", "args",
  "trues", "@1", "arbitraries", "@2", "lists", "numbers", "whitespace", 0
};
#endif
...
{
       3,     0,     8,     1,     0,     0,     0,     0,     0,     0,
       0,     0,     5,     0,     0,     0,     0,    15,     0,     2,
       0,     0,     0,     0,     0,    19,    17,     4,     7,     6,
      13,    13,     0,     0,     0,    19,     0,     0,    13,    13,
      16,     0,     0,    10,    14,    12,     0,     0,     0,    24,
       9,    11,    22,    18,    22,    20,    25,    21,    23
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,    20,     5,    36,    11,    25,    19,    35,
      34,    55,    53
};
...
{
     -32,    22,    21,   -32,    12,    -4,    17,    15,    16,     0,
      20,    23,   -32,    19,    24,    18,    26,   -32,    25,   -32,
      -2,    27,    30,    28,    29,   -32,   -32,   -32,   -32,   -32,
     -32,   -32,    31,    34,    -1,   -32,     3,     4,   -32,   -32,
     -32,    33,     5,   -32,   -32,   -32,     9,    10,    35,   -32,
     -32,   -32,    36,    38,   -32,    37,   -32,    37,   -32
};
...
{
      37,     7,     8,     9,    10,    15,    16,    46,    47,    27,
      40,    28,    29,    41,    43,    45,    49,    44,    44,    41,
      50,    51,     3,    44,    44,     4,     6,    12,    13,    14,
      17,    23,    18,    21,    57,    26,    42,    30,    22,    24,
      31,    38,    32,    33,    39,    48,    54,     0,    52,    56,
      58
};

static const yytype_int8 yycheck[] =
{
      31,     5,     6,     7,     8,     5,     6,    38,    39,    11,
      11,    13,    14,    14,    11,    11,    11,    14,    14,    14,
      11,    11,     0,    14,    14,     4,    14,    10,    13,    13,
      10,    13,     9,    14,    54,    10,    35,    10,    14,    13,
      10,    10,    14,    14,    10,    12,    10,    -1,    13,    11,
      13
};
...
{
       0,    16,    17,     0,     4,    19,    14,     5,     6,     7,
       8,    21,    10,    13,    13,     5,     6,    10,     9,    23,
      18,    14,    14,    13,    13,    22,    10,    11,    13,    14,
      10,    10,    14,    14,    25,    24,    20,    20,    10,    10,
      11,    14,    25,    11,    14,    11,    20,    20,    12,    11,
      11,    11,    13,    27,    10,    26,    11,    26,    13
};
  ...
  switch (yyn)
    {
        case 4:
#line 206 "parse.yy"
    { addDomain((yyvsp[(3) - (6)].character)); ;}
    break;

  case 6:
#line 210 "parse.yy"
    { v_transl.push_back(copy((yyvsp[(2) - (2)].character))); ;}
    break;

  case 7:
#line 211 "parse.yy"
    { char s[13]; sprintf(s,"%d",(yyvsp[(2) - (2)].integer)); v_transl.push_back(copy(s)); ;}
    break;
...
#line 216 "parse.yy"
    {  int add = 1;
               ...
               translation::data.symbols.push_back(translation::Symbol(copy((yyvsp[(5) - (8)].character)),v_transl,(yyvsp[(4) - (8)].integer),(yyvsp[(4) - (8)].integer)+add,true));
               v_transl.clear();
            ;}
    break;
...
#line 226 "parse.yy"
    {  int add = 1;
               for (int a=0; a<v_transl.size(); ++a) // order <types> <symbols> has to be correct in order to do this!!
                  add *= translation::data.domain_elements[translation::data.domains[v_transl[a]]].size();
               translation::data.symbols.push_back(translation::Symbol(copy((yyvsp[(5) - (8)].character)),v_transl,(yyvsp[(4) - (8)].integer),(yyvsp[(4) - (8)].integer)+add,false));
               v_transl.clear();
            ;}
    break;
...
#line 243 "parse.yy"
  ...
  case 17:
#line 246 "parse.yy"
    { parsing_trues = false; parsing_arbitraries = true; ;}
    break;

  case 20:
#line 251 "parse.yy"
    {	if (parsing_trues) { // TODO (both here and under "function") take into account predicates and function symbols with same name!!
                  translation::data.trues_ids.push_back(pair<pair<char*,int>, int>(pair<char*,int>(copy((yyvsp[(2) - (5)].character)), (yyvsp[(4) - (5)].integer)),translation::data.trues.size()));
                  for (int i=0; i<numbers.size(); i++)
                     translation::data.trues.push_back(numbers[i]);
                  numbers.clear();
               } else {
                  assert(parsing_arbitraries);
                  translation::data.arbitraries_ids.push_back(pair<pair<char*,int>, int>(pair<char*,int>(copy((yyvsp[(2) - (5)].character)), (yyvsp[(4) - (5)].integer)),translation::data.arbitraries.size()));
                  for (int i=0; i<numbers.size(); i++)
...
#line 265 "parse.yy"
    {	if (parsing_trues) {
                  translation::data.trues_ids.push_back(pair<pair<char*,int>, int>(pair<char*,int>(copy((yyvsp[(2) - (6)].character)), (yyvsp[(4) - (6)].integer)),translation::data.trues.size()));
                  for (int i=0; i<numbers.size(); i++)
                     translation::data.trues.push_back(numbers[i]);
                  numbers.clear();
               } else {
                  assert(parsing_arbitraries);
                  translation::data.arbitraries_ids.push_back(pair<pair<char*,int>, int>(pair<char*,int>(copy((yyvsp[(2) - (6)].character)), (yyvsp[(4) - (6)].integer)),translation::data.arbitraries.size()));
                  for (int i=0; i<numbers.size(); i++)
                     translation::data.arbitraries.push_back(numbers[i]);
                  numbers.clear();
               }
  ...
  case 23:
#line 282 "parse.yy"
    {  numbers.push_back((yyvsp[(2) - (2)].integer));
            ;}
    break;
