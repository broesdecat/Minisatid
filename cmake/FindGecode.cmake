...
if(GECODE_FOUND)
	...
	find_library(GECODE_DRIVER_LIBRARY PATHS ${GECODE_LIBDIR} gecodedriver)
	if(GECODE_DRIVER_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_DRIVER_LIBRARY})
	endif()
	find_library(GECODE_FZ_LIBRARY PATHS ${GECODE_LIBDIR} gecodeflatzinc)
	if(GECODE_FZ_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_FZ_LIBRARY})
	endif()
	find_library(GECODE_GIST_LIBRARY PATHS ${GECODE_LIBDIR} gecodegist)
	if(GECODE_GIST_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_GIST_LIBRARY})
	endif()
	find_library(GECODE_GRAPH_LIBRARY PATHS ${GECODE_LIBDIR} gecodegraph)
	if(GECODE_GRAPH_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_GRAPH_LIBRARY})
	endif()
	find_library(GECODE_INT_LIBRARY PATHS ${GECODE_LIBDIR} gecodeint)
	if(GECODE_INT_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_INT_LIBRARY})
	endif()
	find_library(GECODE_MM_LIBRARY PATHS ${GECODE_LIBDIR} gecodeminimodel)
	if(GECODE_MM_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_MM_LIBRARY})
	endif()
	find_library(GECODE_SCHEDULING_LIBRARY PATHS ${GECODE_LIBDIR} gecodescheduling)
	if(GECODE_SCHEDULING_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_SCHEDULING_LIBRARY})
	endif()
	find_library(GECODE_SEARCH_LIBRARY PATHS ${GECODE_LIBDIR} gecodesearch)
	if(GECODE_SEARCH_LIBRARY)
		list(APPEND Gecode_LIBRARIES ${GECODE_SEARCH_LIBRARY})
	endif()
	find_library(GECODE_SET_LIBRARY PATHS ${GECODE_LIBDIR} gecodeset)
